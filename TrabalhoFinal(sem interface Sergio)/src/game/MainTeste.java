...
public class MainTeste {
	...
	public static void main(String[] args) {
		...
		initiatePlay(UBU,3, 0, 7, missions);
		
	}
	

	public static void initiatePlay(Kingdom initialLoc, int initialCoins, int initialPowerGem, int initialPowerLimit, List gameMissions) {
		...
		for (int i = 0; i<missions.size(); i++) {
			...
			System.out.println((i+1)+ ".Localização: "+mission.miissionOrigin.getNameK() + " Missâo: " + mission.description);
		}
		...
		while (true) {
			...
			//MISSÃO 1
			if((currentLoc == mission1.miissionOrigin)) {
			...
			//MISSÃO 2
			if((currentLoc == mission2.miissionOrigin)) {
